...
class KubaGame:
    ...
    def __init__(self, (Player_a, color_a), (player_b, color_b)):
        ...
        self._game_board[0][0],  self._game_board[0][1],  self._game_board[1][0],  self._game_board[1][1] = "W", "W", "W", "W"
        self._game_board[5][5], self._game_board[5][6], self._game_board[6][5], self._game_board[6][6] = "W", "W", "W", "W"
        self._game_board[5][0], self._game_board[5][1], self._game_board[6][0], self._game_board[6][1] = "B", "B", "B", "B"
        self._game_board[0][5], self._game_board[0][6], self._game_board[1][5], self._game_board[1][6] = "B", "B", "B", "B"
        for y in range(1, 6):
    ...
    def get_current_turn(self):
        """Returns the player whose turn it is to make a move, and returns None if no one has moved yet"""
